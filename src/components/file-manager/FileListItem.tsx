...
export function FileListItem({ node, onSelect, isSelected }: FileListItemProps) {
  ...
  return (
    <div
      className={cn(
        ...
        isSelected ? 'border-accent ring-1 ring-accent bg-accent/10 dark:bg-accent/20 text-accent-foreground' : 'hover:border-accent/50 focus-within:border-accent border border-transparent',
        'group' 
      )}
    ...
    >
      ...
      <Button
        variant="ghost"
        size="icon"
        className="ml-2 h-7 w-7 p-1 text-muted-foreground hover:text-accent-foreground flex-shrink-0" 
